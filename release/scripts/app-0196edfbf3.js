...
(function () {
    'use strict';
    angular.module("BlurAdmin.pages")
        .constant("servidor", "http://localhost:3000/") //https://songa-backend2.herokuapp.com/
        .constant("cargos", [
...
(function () {
    ...
    comunFactory.$inject = ["logoB64"];

    /** @ngInject */
    function comunFactory (logoB64) {
      return {
...
(function () {
    ...
    clienteCtrl.$inject = ["$scope", "clientesFactory", "comunFactory"];
    angular.module("BlurAdmin.pages.clientes")
        .controller("clienteCtrl",clienteCtrl);

    /** @ngInject */
    function clienteCtrl ($scope,clientesFactory, comunFactory) {
        //Cargar el listado
        ...
        $scope.generarReporte = function () {
            var columnas = [
                ...
                {title:"Fecha nacimiento", "dataKey":"fechanac"},
...
(function () {
    ...
    function historicoCtrl($scope, honorariosFactory, tratamientosFactory, comunFactory) {
        ...
        $scope.generarReporte = function () {
            ...
            console.log($scope.hArray.historicoFiltrado);
            var columnas = [
                {title: "Fecha", "dataKey": "fecha_pago"},
...
//# sourceMappingURL=../maps/scripts/app-0196edfbf3.js.map
